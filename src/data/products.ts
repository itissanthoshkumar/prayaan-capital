...
export const productData: Record<string, ProductPageData> = {
  "business-loan": {
    ...
    tagline: "Unsecured-feel pricing for secured MSME term loans up to ₹30L. AI underwriting completes in 24 hours.",
    icon: Building2,
    range: "₹5L – ₹30L",
    tenure: "12 – 60 months",
    rate: "From 16% p.a.",
  ...
  "loan-against-property": {
    ...
    tagline: "A secured business loan against property you already own, for any business need, with tenures up to 10 years.",
    icon: Landmark,
    range: "₹5L – ₹30L",
    ...
    highlights: [
      ...
      { label: "Interest", value: "Attractive" },
    ],
    features: [
  ...
  "msme-loan": {
    ...
    rate: "From 16% p.a.",
    highlights: [
      { label: "Loan Amount", value: "₹3L – ₹30L" },
