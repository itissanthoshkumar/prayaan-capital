      ...
      <div className="container mx-auto px-5">
        ...
        >
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-xl mx-auto font-body">
            Prayaan Capital is an MSME-first NBFC — Micro, Small and Medium Enterprises are the backbone of our portfolio. Secured loans backed by the property you own, enabling financial inclusion for India's small entrepreneurs.
          </p>
        </motion.div>
