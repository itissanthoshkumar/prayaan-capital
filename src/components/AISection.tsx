...
const features = [
  ...
  { icon: TrendingUp, title: "Consent-Led Data Use", desc: "We collect only what you share, for the purpose you authorise. Our data governance is built to RBI's digital lending guidelines — no surprise usage.", tint: "bg-gradient-mint", stat: "RBI", statLabel: "Registered" },
