...
const DocumentChecklist = () => (
  <LegalPageTemplate
    ...
    sections={[
      ...
      { title: "Business proof", content: <Section items={["GST registration certificate", "Udyam / MSME registration", "Shop & Establishment certificate", "Partnership deed / MoA & AoA / LLP agreement"]} /> },
