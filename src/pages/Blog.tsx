...
const posts = [
  { slug: "ai-underwriting-msme", title: "How AI underwriting is rewriting MSME credit", read: "6 min", tag: "AI" },
  { slug: "lap-vs-business-loan", title: "LAP vs Business Loan: which fits your MSME?", read: "5 min", tag: "Guides" },
  { slug: "gst-cash-flow", title: "Reading GST returns to predict cash-flow stress", read: "7 min", tag: "Insights" },
  { slug: "women-entrepreneurs-india", title: "Women entrepreneurs and the credit gap in India", read: "8 min", tag: "MSME" },
  ...
  <Layout>
    <section className="pt-24 pb-8 md:pt-32 md:pb-12 bg-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 relative z-10">
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-xl">Practical credit, AI and MSME know-how from our team.</p>
          </div>
