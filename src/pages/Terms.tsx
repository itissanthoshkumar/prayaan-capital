...
const sections = [
  ...
  { title: "4. Loan Application Process", content: "Loan applications are subject to our credit assessment process which includes bureau-assisted underwriting, KYC verification, property valuation, collateral evaluation, and human review by an authorised officer. Submission of an application does not guarantee loan approval." },
  { title: "5. Interest Rates and Fees", content: "Interest rates are determined based on bureau data, property valuation, and credit assessment, and may vary between applicants. All applicable fees, charges, and the Annual Percentage Rate (APR) will be disclosed in the sanction letter before loan disbursal." },
