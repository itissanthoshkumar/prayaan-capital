...
const sections = [
  ...
  { title: "2. Eligibility", content: "To use our services, you must be: an Indian resident aged 21 years or above, operating a registered MSME or business entity in India, legally competent to enter into a binding contract, and not disqualified from applying for credit by any regulatory authority." },
  { title: "3. Services Offered", content: "Prayaan Capital provides secured business loans to MSMEs including Business Term Loans, Loan Against Property, Machinery & Equipment Finance, and Working Capital Loans. All lending activities are conducted as per RBI Master Directions for Non-Banking Financial Companies." },
