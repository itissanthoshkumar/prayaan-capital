  ...
  <Layout>
    <section className="pt-24 pb-12 md:pt-32 md:pb-20 bg-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="font-display text-3xl md:text-5xl font-extrabold text-foreground mt-4 mb-3">Customer Login</h1>
    ...
    <section className="py-12 md:py-20 bg-background">
      <div className="container mx-auto px-5 max-w-4xl grid md:grid-cols-2 gap-6">
        <div className="bg-card rounded-3xl border border-border/60 p-6 md:p-8 shadow-card relative">
